...
<body>
                        ...
                        <div class="container p-4">
                            ...
                            <form action="#" method="post">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <small id="togglePassword" class="text-primary" style="font-size: 15px; cursor: pointer; display: block; margin-top: 5px;">View Password</small>
                                </div>
    ...
    <div class="container text-center">
        <p class="mb-2">
            PRMS-Matalom. All Rights Reserved &copy; <?php echo date("Y"); ?>
        </p>
        <p class="mb-2">
            By <a href="https://web.facebook.com/superjansnoww" target="_blank" rel="noopener noreferrer" style="text-decoration: underline; color: white;">EVSU Cuties</a>
        </p>
    </div>
</footer>
