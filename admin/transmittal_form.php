        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <h1 class="text-center">ICT Transmittal Form</h1>
                </div>
            </div>

            <?php
            $sql = "SELECT date_of_request, div_sec_unit_served, request_description, date_finished, rating FROM transmittalform";
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            echo "<tr>
                                                ...
                                                <td>" . $row["div_sec_unit_served"] . "</td>
                                                <td>" . $row["request_description"] . "</td>
                                                <td>" . ($row["date_finished"] ? $row["date_finished"] : "Pending") . "</td>
                                                <td>" . ($row["rating"] ? $row["rating"] : "Not Rated") . "</td>
                                            </tr>";
                                        }
                                    } else {
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addDataForm">
                        ...
                        <div class="form-group">
                            <label>Div/Sec/Unit Served</label>
                            <input type="text" class="form-control" name="div_sec_unit_served" required>
                        </div>
                        <div class="form-group">
                            <label>Request Description</label>
                            <textarea class="form-control" name="request_description" required></textarea>
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="exportPdfForm">
                        ...
                        <!-- Year Dropdown (from current year to 1969) -->
                        <div class="form-group">
    ...
    $(document).ready(function() {
        ...
        $("#exportPdfModal").on("show.bs.modal", function(e) {
            ...
            if (selectedRow.length) {
                ...
                const rating = selectedRow.find("td:eq(4)").text();
        ...
        $("#exportPdfForm").on("submit", function(e) {
            ...
            window.open("transmit_pdf.php?" + formData, "_blank");
